...
def main():
    ...
    print("""
  ######################################
  # SGC_STATS3 Development Environment Setup #
  ######################################

  This script will create your SGC_STATS3 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your SGC_STATS3 project folder:
    [Arma 3 installation directory]\\{} => SGC_STATS3 project folder
    P:\\{}                              => SGC_STATS3 project folder
