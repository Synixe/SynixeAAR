...
def main():
  ...
  This script will create your SGC_STATS dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your SGC_STATS project folder:
    [Arma 3 installation directory]\\{} => SGC_STATS project folder
    P:\\{}                              => SGC_STATS project folder
